...
ash-nazg heeft 6 docs-pagina's zonder contractstructuur; wave 2.
...
- `installation.md`, `demo.md`, `bring-your-own-content.md`,
  `user-guide.md` -> `how-to/`; `security-model.md` -> `explanation/`;
  `testing.md` -> `explanation/`. Stubs achterlaten.
- Licentie is AGPL-3.0: NIET wijzigen; bewuste afwijking.
- Taal: Engels (publiek repo).
